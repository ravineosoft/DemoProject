...
public class WebController {
   ...
   public String index(Model model) {
	   ...
	   /*for (User user : userList) {
		   ...
		   chartDataMap.put("Letter", user.getFirstName());
		   chartDataMap.put("Freq", user.getId().toString());
   ...
   public String greetingSubmit(@ModelAttribute User user, Model model, @RequestParam("image") MultipartFile multipartFile, RedirectAttributes redirectAttributes) {
